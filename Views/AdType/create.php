...
if(!empty($_POST["adTypeId"])&& !empty($_POST["adTypeName"])){
    ...
    try {
        ...
        $adType = new AdType($adTypeId, $adTypeName);
        $result = $adType->create($connection);
        if ($result == true) {
            echo "<p class='text-center'>The ad type was added successfully!</p> <br/>";
        }else{
...
?>
<div class="container">
	<h1 class=text-center>New Ad Type</h1>
