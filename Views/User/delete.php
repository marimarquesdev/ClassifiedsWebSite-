...
if(!empty($_POST["userId"])){
    ...
    try {
        ...
        $result=$user->delete($connection);
        if ($result == true) {
            echo "<p class='text-success text-center'>The User with the id $userId was deleted successfully!</p> <br/>";
        }else{
...
<div class="container">
    ...
    <form action="#" method="POST">
    	<p class="text-danger">Are you sure you want to delete de User?</p>
